                            ...
                            if(isAdmin) {
                                row += `<td>
                                    <div class="btn-group">
                                        ...
                                        <button class="btn-danger" onclick="eliminarMaterial(${m.id}, '${m.nome.replace(/'/g, "\\'")}')">🗑️ Eliminar</button>
                                    </div>
                                </td>`;
                            }
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button class="btn-danger" onclick="eliminarUsuario(${u.id}, '${u.nome.replace(/'/g, "\\'")}')">🗑️ Eliminar</button>
                                    </div>
                                </td>
                            </tr>
                        `;
